...
function isItABST(t){
  //need to check the left and right children to the root to see if they're greater or less than the root and keep checking for the length of the tree==if there is any break in this rule it isn't a BST
}
